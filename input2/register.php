...
if($_GET['error']=='2')
	echo '<p style="color: red; text-align: center">
	  ...
	  if($_GET['error']=='3')
	echo '<p style="color: red; text-align: center">
      mobile and pin should be numeric !
      </p>';
...
?>
  <form method="post" action="registeruser.php" >
	<table>
		...
		<tr>
			<td>Name</td>
			<td><input style="text-transform: uppercase" type="text" name="name" maxlength="30"></td>
		</tr>
		...
		<tr>
			...
			<td><input  style="text-transform: uppercase" type="text" name="father_name" maxlength="30"></td>
		</tr>
	
		<tr>
			<td>Student Register Number</td>
			<td><input style="text-transform: uppercase" type="text" name="regno" maxlength="10"></td>
		</tr>
		...
		<tr>
			...
			<td><textarea name="address" rows="4" cols="24"></textarea></td>
		</tr>
		...
		<tr>
			...
			<td><input type="password" name="psw" maxlength="20"></td>
		</tr>

		<tr>
			<td>Confirm Password</td>
			<td><input type="password" name="cpwd" maxlength="20"></td>
		</tr>
